...
2. Click **New context** and note the public **Context ID** (for example `ctx_101`). The console stores an internal numeric row ID, but API calls should use the `ctx_` prefixed form.
...
4. Save the configuration and share the prefixed context ID with your engineering team.
