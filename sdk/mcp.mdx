...
After connection (hosted or local), run the smallest end-to-end loop before adding custom prompts or automations. Keep the first pass read-only so the assistant can investigate ranking behavior without mutating a production surface.
