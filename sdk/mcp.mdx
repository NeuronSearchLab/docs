...
Uses OAuth 2.0 client credentials to authenticate against the public API (`api.neuronsearchlab.com/v1`). This mode provides access to recommendations, catalog management, events, segments, experiments, campaigns, and analytics.
