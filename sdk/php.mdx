...
Every search is an event that steers the user's later recommendations by the weight of your Search event. If your own engine runs the search, send NSL the query and the IDs it showed:
...
Requires `neuronsearchlab/sdk-php` 2.2.0 or later. See [searches are events](/guides/events#searches-are-events).
