...
For endpoint-specific authentication details, refer to the [API Reference introduction](/api-reference/introduction), the [JavaScript SDK](/sdk/introduction), or the [PHP SDK](/sdk/php).
