...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/sdk/mcp"
  >
    Install NeuronSearchLab in ChatGPT, or connect Claude, Codex, and other clients through hosted MCP.
  </Card>
  <Card
    ...
    href="/guides/vercel"
  >
    Provision a recommendation workspace and server-only configuration from Vercel Marketplace.
  </Card>
  <Card
    title="PHP SDK"
    icon="code"
