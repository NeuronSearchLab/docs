...
| **Endpoint** | Console Platform API (`console.neuronsearchlab.com/api/...`) | Public API (`api.neuronsearchlab.com/v1`) |
...
```bash
curl "https://console.neuronsearchlab.com/api/recommendations?user_id=42&context_id=ctx_101" \
