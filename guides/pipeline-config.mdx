...
> Use [Studio](/guides/studio-workflow) first for single-surface workflow changes. This page is the advanced pipeline reference.
...
| **Rules** | Apply business rules (boost, bury, pin, filter, diversify) | Can be disabled entirely |
