...
4. Recommendation serving still goes through the Core API at `https://api.neuronsearchlab.com/v1/recommendations`. There is no documented `GET /api/recommendations` Platform API route.
