...
<Steps>
  <Step title="Create or update signals">
    Create or update a signal template on the **Events** page.
  </Step>
  <Step title="Start training">
    Start a training run from that template.
  </Step>
  <Step title="Create a trained version">
    Let the platform create a **new trained version**.
  </Step>
  <Step title="Review the result">
    Review the result on the **Models** page.
  </Step>
  <Step title="Add a label">
    Optionally add a human-friendly label and description.
  </Step>
  <Step title="Approve the version">
    Approve the trained version when it is ready.
  </Step>
  <Step title="Promote to serving">
    Promote it to a serving target when you want it live.
  </Step>
  <Step title="Repeat when retraining">
    Repeat the same flow whenever you retrain.
  </Step>
</Steps>
...
<Steps>
  <Step title="Open training or models">
    Open [Console > Training Jobs](https://console.neuronsearchlab.com/training-jobs) or [Console > Models](https://console.neuronsearchlab.com/models).
  </Step>
  <Step title="Approve the completed version">
    Find the completed version and click **Approve**.
  </Step>
  <Step title="Confirm approved status">
    The version status updates to **Approved**.
  </Step>
</Steps>
...
<Steps>
  <Step title="Find the approved version">
    Find the approved trained version.
  </Step>
  <Step title="Start promotion">
    Click **Promote to production**.
  </Step>
  <Step title="Choose a serving target">
    Choose the serving target you want to update.
  </Step>
  <Step title="Watch target status">
    The console will show the target status updating.
  </Step>
  <Step title="Confirm production traffic">
    Once the target returns to a healthy state, the promoted version is live and subsequent recommendation requests use it.
  </Step>
</Steps>
