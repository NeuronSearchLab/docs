...
For project provisioning and server-only credentials, use the [Vercel native integration](/guides/vercel). For ChatGPT, install NeuronSearchLab from the OpenAI plugin directory and authorize your console account. Other AI clients can use the [hosted MCP integration](/sdk/mcp).
