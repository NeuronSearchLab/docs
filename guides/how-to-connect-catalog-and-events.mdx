...
1. Decide whether your source catalog will provide stable item IDs or let NeuronSearchLab generate them.
...
2. App session requests recommendations from the Core API recommendation endpoint.
