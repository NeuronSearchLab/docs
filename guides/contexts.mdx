...
5. Choose the recommendation type / model family, such as **General**, **Similar Items**, **Watch Next**, **Trending**, or **Email Digest**, depending on which model families are enabled for your tenant.
6. Save the context and note its ID, such as `101`. Your engineering team will pass this ID in `context_id` on recommendation requests.
