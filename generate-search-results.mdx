...
Search lets your application send a free-text query and receive ranked catalog items through the same serving pipeline used for recommendations. It is a Core API feature for your product experience and uses the AWS API Gateway endpoint at `https://api.neuronsearchlab.com/v1/search`.
