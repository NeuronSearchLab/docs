...
1. Create a prefixed context ID for each surface, such as `ctx_101`, and document the desired business logic.
2. Configure default filters, ranking modifiers, and fallbacks inside the console under **Contexts**.
3. Reference the prefixed context ID in every recommendation request to ensure consistent behavior.
