...
<Update label="September 20, 2026" rss="September 20, 2026: Admin console.">
...
<Update label="September 19, 2026" rss="September 19, 2026: Admin console.">

### Admin console

#### Features

- **Catalog, users, and events** — Refresh the catalogue: pipeline names now use + rather than an arrow

</Update>

<Update label="September 18, 2026" rss="September 18, 2026: Admin console.">

### Admin console

#### Features

- **Catalog, users, and events** — Refresh the model catalogue from benchmark v3.2

</Update>

<Update label="September 17, 2026" rss="September 17, 2026: Admin console.">
...
<Update label="September 16, 2026" rss="September 16, 2026: Admin console.">
...
<Update label="September 15, 2026" rss="September 15, 2026: Admin console.">

### Admin console

#### Features

- **Catalog, users, and events** — Seed recommendations from an item so related-items needs no events
- Configure a tenant from its own website instead of asking

#### Bug fixes

- Fix embeddings upserts and crawl a site into a catalogue

</Update>

<Update label="September 6, 2026" rss="September 6, 2026: Admin console.">

### Admin console

#### Features

- **Platform foundation** — Restore the dashboard intro banner with a tactile identity surface
- **Ranking controls** — Rank scenario boards over the whole 23-system field

#### Bug fixes

- Revert "Restore the dashboard intro banner with a tactile identity surface"

</Update>

<Update label="September 5, 2026" rss="September 5, 2026: Admin console.">

### Admin console

#### Features

- **Platform foundation** — Refine dashboard context and add tactile primary buttons

</Update>

<Update label="September 3, 2026" rss="September 3, 2026: Admin console.">

### Admin console

#### Features

- **Ranking controls** — Serve recommendations through a model-agnostic provider chain

</Update>

<Update label="September 2, 2026" rss="September 2, 2026: Admin console, MCP server.">
...
<Update label="September 1, 2026" rss="September 1, 2026: Admin console.">

### Admin console

#### Features

- **Model lifecycle** — Provision interest-based sample workspaces

#### Bug fixes

- Keep run status live instead of stuck on Started
- Grant pipeline role the data bucket and unclip job details
- Use the SageMaker.RESOURCE_LIMIT retry enum
...
<Update label="August 21, 2026" rss="August 21, 2026: Admin console, TypeScript SDK, PHP SDK, MCP server, Next.js SDK, Next.js personalized starter.">
...
<Update label="August 20, 2026" rss="August 20, 2026: Admin console, Next.js SDK, Vercel integration, Next.js personalized starter.">
...
<Update label="August 16, 2026" rss="August 16, 2026: Admin console, MCP server.">
...
<Update label="August 6, 2026" rss="August 6, 2026: Admin console, MCP server.">
...
<Update label="July 22, 2026" rss="July 22, 2026: Admin console, MCP server.">
...
<Update label="July 20, 2026" rss="July 20, 2026: Admin console, MCP server.">
...
<Update label="July 7, 2026" rss="July 7, 2026: TypeScript SDK, PHP SDK, MCP server.">
...
<Update label="June 7, 2026" rss="June 7, 2026: Admin console, TypeScript SDK.">
...
<Update label="June 2, 2026" rss="June 2, 2026: Admin console, TypeScript SDK, PHP SDK.">
...
<Update label="June 1, 2026" rss="June 1, 2026: Admin console, TypeScript SDK, PHP SDK.">
...
<Update label="April 29, 2026" rss="April 29, 2026: Admin console, TypeScript SDK, PHP SDK.">
...
<Update label="April 7, 2026" rss="April 7, 2026: Admin console, MCP server.">
...
<Update label="April 6, 2026" rss="April 6, 2026: Admin console, MCP server.">
...
<Update label="April 5, 2026" rss="April 5, 2026: Admin console, TypeScript SDK, PHP SDK, MCP server.">
...
<Update label="April 4, 2026" rss="April 4, 2026: Admin console, MCP server.">
...
<Update label="April 3, 2026" rss="April 3, 2026: Admin console, MCP server.">
