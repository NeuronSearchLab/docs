...
| `GET` | `/v1/items/{id}` | `neuronsearchlab-api/read` |
| `POST` | `/v1/items/{id}` | `neuronsearchlab-api/write` |
| `DELETE` | `/v1/items/{id}` | `neuronsearchlab-api/write` |
| `POST` | `/v1/events` | `neuronsearchlab-api/write` |
| `GET` | `/v1/events` | `neuronsearchlab-api/read` |
| `GET` | `/v1/events/{id}` | `neuronsearchlab-api/read` |
