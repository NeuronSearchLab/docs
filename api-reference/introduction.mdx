...
<Note>
All endpoints are protected by Bearer token authentication managed by NeuronSearchLab. Make sure you obtain a valid access token via the `/auth/token` endpoint before making requests.
</Note>
...
Tokens are issued by the NeuronSearchLab identity service. Scopes used:
...
- [JavaScript SDK on npm](https://www.npmjs.com/package/@neuronsearchlab/sdk)
- [PHP SDK on Packagist](https://packagist.org/packages/neuronsearchlab/sdk-php)
- [PHP SDK source on GitHub](https://github.com/NeuronSearchLab/neuronsearchlab-sdk-php)
