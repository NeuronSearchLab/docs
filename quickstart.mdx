...
If you prefer higher level abstractions, install the [official SDK](https://www.npmjs.com/package/@neuronsearchlab/sdk) and call `sdk.getRecommendations()` from your server.
...
- **Context** — Define contexts for each recommendation surface with filters, influence rules, and grouping.
- **Rules Engine** — Create business rules to boost, bury, pin, filter, or diversify items.
